...
searchBtn.onclick = function () {
  ...
  welcome.innerHTML = 'im totally up for exploring different cities with you,just let me know which city your interested next';
};
...
searchBox.onclick = function () {
  welcome.innerHTML = 'Which city weather are you curious about?';
};
searchBox.onmouseleave = function () {
  welcome.innerHTML = 'want to know what the weather is like in any city';
};